...
public interface BookingService {
    ...
    List<Booking> getAllBookingsByUser(Long userId, String state, LocalDateTime dateTime);

    List<Booking> getAllBookingsByOwner(Long ownerId, String state, LocalDateTime dateTime);
