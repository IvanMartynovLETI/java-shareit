...
INSERT INTO items(name, description, available, owner_id) values ('item1', 'description of item1', true, 1)
INSERT INTO bookings(start, end, item_id, booker_id, status) values ('2022-08-05 18:36', '2022-08-05 19:00', 1, 2, 'APPROVED')
